...
//        System.out.println("结果："+dp(7)+"动态规划共计算几次："+DPCount);//动态规划运行几次：5，结果13
     ...
     * 从5开始
     *  内层
     *  第一轮：57比，然后72比，然后76比，然后710比。(因为72是错误组合，所以76比。 57和710组合放入goodCombinationSet，72和76组合放入badCombinationSet)
     *  第二轮：52比，然后56比，然后610比(因为52是错误组合，所以76比)
     *  第二轮：56比，然后610比
     * 然后从7开始
     *  第一轮：72比，然后76比，然后710比。(因为72是已知错误组合，直接跳过，所以76比，76也是已知错误组合再跳过。710是一致正确组合直接录入)
     *  第二轮：76比，然后710比。(因为76是已知错误组合，所以710比)
     *  第二轮：710比
     * ...
     *
     * @param arr
