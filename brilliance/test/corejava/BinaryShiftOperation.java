...
*  		反码：1(27个1)0111
*  		补码：1(27个1)1000
*  8位有符号（有正数和负数）二进制数的范围是：
最大：0111 1111=2的7次方-1=127
最小：1000 0000=-2的7次方=-128
注：1111 1111=-（2的7次方-1）=-127，大于1000 0000
* 
...
public class BinaryShiftOperation {
	...
	public static void main(String[] args) {
		...
		System.out.println((-8>>1)+"二进制表示："+Integer.toBinaryString(-8>>1));//右移1位。1(27个1)1000>>1=1(27个1)100,求原负数取反加1，=1(27个0)100=-4
		System.out.println((8>>>1)+"二进制表示："+Integer.toBinaryString(8>>>1));//右移1位。1000>>>1=100=4
