...
public class QRCodeGenerator {
	...
	public void encoderQRCode(String content, String imgPath) {
		this.encoderQRCode(content, imgPath, "png", IMAGE_SIZE);
	}
	...
	public void encoderQRCode(String content, OutputStream output) {
		this.encoderQRCode(content, output, "png", IMAGE_SIZE);
	}
	...
	public void encoderQRCode(String content, String imgPath, String imgType) {
		this.encoderQRCode(content, imgPath, imgType, IMAGE_SIZE);
	}
	...
	public void encoderQRCode(String content, OutputStream output,
			String imgType) {
		this.encoderQRCode(content, output, imgType, IMAGE_SIZE);
	}
	...
	private BufferedImage qRCodeCommon(String content, String imgType, int size) {
		...
		try {
			...
			insertImage(bufImg, "D:\\qrcode\\logo.png", true, imgSize);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return bufImg;
	 ...
	 * 解析二维码（QRCode）
	 * 
	 * @param imgPath QRCode 二维码图片的文件 File
	 * @return
	 */
	...
	public static void main(String[] args) {
		String imgPath = "D:\\qrcode/Flash_QRCode.png";
		String encoderContent = "Hello 大大、小小,welcome to QRCode!"
				+ "\nMyblog [ http://localhost:8080/brilliance ]"
				+ "\nEMail [ flashboy2008@gmail.com ]";
