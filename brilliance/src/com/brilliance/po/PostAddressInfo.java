...
public class PostAddressInfo {
	...
	public PostAddressInfo(){
		
	}

	

	public PostAddressInfo(Integer id,String expressCode, String userId, String postName,
			String companyName, String province, String city, String area,
			String streetName, String mobile, String tailAddress,
