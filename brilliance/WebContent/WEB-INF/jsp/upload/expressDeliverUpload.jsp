...
<title>价格和配送天数导入</title>
<head>
</head>
<body>
<div class="container">
<div class="panel panel-default">
	<div class="panel-heading">价格和配送天数导入</div>
</div>
<div id="warningAlert" class="alert alert-danger" style="display:none"></div>
<form method="post" id="form1" action="expressDeliverUpload" onsubmit="return haveFile();" enctype="multipart/form-data">
