			    ...
			    <form class="form-horizontal" role="form"  id="register" action="register" method="post">
			        <div class="form-group">
			            <label for="inputMobile" class="col-sm-2 control-label" >
			            	<strong style="color:red">*</strong>电话号码
			            </label>
			            <div class="col-xs-3">
			                <input type="tel" class="form-control" id="inputMobile" name="mobile" placeholder="手机号码" data-validation="custom" data-validation-regexp="^[1][358]\d{9}$" data-validation-error-msg="请输入11位手机号码">
			            </div>
			        </div>
			        <div class="form-group">
			            ...
			            <div class="col-xs-3">
			                <input type="tel" class="form-control" id="inputName" name=userName placeholder="用户名" data-validation="custom" length="50" data-validation-error-msg="用户名">
			            </div>
			        </div>
			        ...
			        <div class="form-group">
			            ...
			            <div class="col-xs-3">
			                <input type="email" class="form-control" id="inputEmail" name="email" placeholder="电子邮箱" data-validation="email" data-validation-error-msg="请输入正确的邮箱">
			            </div>
			        </div>
			        <div class="form-group">
			            ...
			            <div class="col-xs-3" id="addressDiv">
			        ...
			        <div class="form-group">
			        	...
			        	<div class="col-md-10">
			        		<a href="backToLogin" class="btn btn-primary">返回</a>
			        	</div>
			        </div>
