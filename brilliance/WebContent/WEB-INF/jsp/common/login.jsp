		...
		<div id="loginModal" class="modal-dialog">
	      <form class="form-signin" role="form" method="post" action="login">
	        ...
	        <div class="form-group">
	        	<input type="text"  name="mobile" class="form-control input-lg" placeholder="手机号码" value="" required autofocus>
	        </div>
	        <div class="form-group">
	        	<input type="password" name="password" class="form-control input-lg" value="" placeholder="密码"required>
	        </div>
	        ...
	        <div class="form-group">
	          ...
	          <span id="regist" class="pull-right"><a href="forwardToRegister" >注册</a></span>
	        </div>
	      </form>
		</div>
    </div> <!-- /container -->
